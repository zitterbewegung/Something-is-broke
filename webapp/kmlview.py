...
GMAPS_API_KEY = 'ABQIAAAAfV18V5x5RyU9qv5v_q1s7RSzCw0MsHESddFVye4L7ygUS5OvBRTzUAFyczEkGuBVNTZYfQRPJLENbA'
...
if __name__ == '__main__':
    ...
    print kml_doc.toprettyxml(indent="  ", encoding='UTF-8')import xml.dom.minidom
